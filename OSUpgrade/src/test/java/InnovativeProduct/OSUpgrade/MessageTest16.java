 ...
 * so first go to moreshooting modes.
 * 
 * 
 */


public class MessageTest16
{
	...
	MessageTest16(AndroidDriver<AndroidElement> driver)
	{
		this.driver=driver;
	...
	public void enterText(String path,String deviceId,String deviceName,String osVersion) throws MalformedURLException, IOException, InterruptedException
	{
		...
		f=new File(path+"\\"+deviceName+"_OS_"+osVersion+"_"+deviceId+"_CameraSettigs.txt");
		fos=new FileOutputStream(f);
		
		//String dummy=path+"\\"+deviceName+"_OS_"+osVersion+"_"+deviceId+"_CameraSettings.xlsx";
		//System.out.println(dummy);
		fx=new File(path+"\\"+deviceName+"_OS_"+osVersion+"_"+deviceId+"_CameraSettings.xlsx");
