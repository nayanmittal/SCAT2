 ...
 * [7-9] adding button descrption.adding image class for more option.changed swipeDown time to 1 second from 2 second.
...
public class SettingTest101 
{
	...
	//,"Contact us","Tips and user manual",
	 String[] skipMenu={"Notifications" ,"Biometrics and security","Wallpaper","Connections","Sounds and vibration","Notifications","Display","Lock screen","Privacy","Location","Wallpapers and themes","Wallpaper and themes","User Manual","Contact us","Themes","Biometrics security patch","Auto-fill service from Google","Hide apps","Game Launcher","Google Location History",
			 ...
			 "Ultra data saving mode","Smart pop-up view","Left shortcut","Right shortcut","App permissions","Permission manager","Open app","Send last location"}; //Ultra data saving mode, need to check not able to take dump of it.//Permission manager-no need to get the lists of permission.
	...
	SettingTest101(AndroidDriver<AndroidElement> driver)
		{
			this.driver=driver;
	...
	public void enterText(String path,String deviceId,String deviceName,String osVersion) throws MalformedURLException, IOException, InterruptedException
	{
		try
		{
			...
			//fx=new File("C:\\Users\\nayan.mittal\\Desktop\\Data\\MenuTreeSetting_Note10_Q_skippin_menu.xlsx");
