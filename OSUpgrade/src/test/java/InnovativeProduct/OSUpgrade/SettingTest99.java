 ...
 * [9-99] changing it to work as per multithreading.
 * 
 */

public class SettingTest99 
{
	...
	SettingTest99(AndroidDriver<AndroidElement> driver)
		{
			this.driver=driver;
