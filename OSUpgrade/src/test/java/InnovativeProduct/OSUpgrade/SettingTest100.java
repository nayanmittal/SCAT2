...
public class SettingTest100 
{
	...
	//,"Contact us","Tips and user manual","Notifications" ,"Biometrics and security","Wallpaper","Connections","Sounds and vibration","Notifications","Display","Lock screen",
	 String[] skipMenu={"Google","User manual","Contact us","Themes","Biometrics security patch","Auto-fill service from Google","Hide apps","Game Launcher","Google Location History","Google Location Sharing","Clock style","Contact information","Swipe","Pattern","PIN","Password","None","Intelligent Scan","Face","Iris","Fingerprints","Full screen apps","Font style","Developer options","Apps","Mobile Hotspot","Bluetooth tethering","USB tethering","Download and install","System WebView licences","Open source licences","Samsung legal","Privacy Policy","Safety information","Security update","App preview messages","Device phone number","Firebase App Indexing"};
	...
	SettingTest100(AndroidDriver<AndroidElement> driver)
		{
			this.driver=driver;
