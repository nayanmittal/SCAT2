...
public class SplashScreenDemo {
    JFrame frame;
    JLabel image=new JLabel(new ImageIcon("D:\\Drive E\\automation tool\\OSUpgrade\\src\\test\\java\\InnovativeProduct\\OSUpgrade\\camera.jpg"));
    JLabel text=new JLabel("Setting Comparison Automation");
